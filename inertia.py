...
'''def a_y_y(area, y, ybar):
    ayy.append(area*(y-ybar))
    
def a_x_x(area, x, xbar):
    ayy.append(area*(x-xbar))'''
...
a_x_x = (arealist[0]*(x_rect1-x_bar))+(arealist[1]*(x_rect2-x_bar))+(arealist[2]*(x_rect3-x_bar))
print(x_rect1)
